...
export default function Footer() {
  return (
    <footer className="bg-[#ee121c] pt-32 pb-12 rounded-t-[3rem] mt-24">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-5">
              <a
                ...
                className="w-8 h-8 rounded-full bg-white/10 hover:bg-white hover:text-[#ee121c] flex items-center justify-center text-white transition-all duration-300"
              >
                <svg
                  width="15"
                  height="15"
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item}>
                  <a
                    href="#"
                    className="text-white/70 hover:text-white text-sm transition-all duration-200 inline-flex items-center gap-1 group"
                  >
