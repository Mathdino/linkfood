 ...
 const HOW_STEPS = [
   {
     ...
     checks: ["Cadastro sem burocracia", "Personalização da loja", "Suporte na configuração"],
     video: "/video1.mp4",
   },
   {
     tag: "Passo 2",
     ...
     checks: ["Fotos e descrições detalhadas", "Combos e promoções", "Preços editáveis a qualquer hora"],
     video: "/video2.mp4",
   },
   {
     tag: "Passo 3",
     ...
     checks: ["Pedidos com todas as informações", "Notificação instantânea", "Histórico completo"],
     video: "/video3.mp4",
   },
 ] as const;
 ...
 export default function HomeClient() {
   ...
   useEffect(() => {
     const ring = isDesktop ? activeRingDesktopRef.current : activeRingMobileRef.current;
     if (!ring) return;
     ...
     gsap.to(ring, {
       ...
       ease: "none",
       onComplete: () => setActiveTestimonial((v) => (v + 1) % TESTIMONIALS.length),
     });
     if (quoteRef.current) {
       gsap.fromTo(
         quoteRef.current,
     ...
     <div className="min-h-screen bg-neutral-950 text-white selection:bg-red-500 selection:text-neutral-950 font-sans overflow-x-hidden">
       ...
       >
         ...
         >
           <div className="flex items-center gap-2">
             <img src={isLight ? "/logo_branco.png" : "/logo.png"} alt="Logo" className="h-15 w-auto" />
           </div>
           <nav className="flex items-center gap-8">
             <a href="#" className="text-sm font-medium hover:text-red-500 transition-colors flex items-center gap-1 group">
               Products <ChevronDown className="w-4 h-4 text-neutral-500 group-hover:text-red-500 transition-colors" />
             </a>
             <a href="#" className="text-sm font-medium hover:text-red-500 transition-colors flex items-center gap-1 group">
               Resources <ChevronDown className="w-4 h-4 text-neutral-500 group-hover:text-red-500 transition-colors" />
             </a>
             <a href="#pricing" className="text-sm font-medium hover:text-red-500 transition-colors">
               Pricing
             </a>
           </nav>
       ...
       <section className="relative pt-32 pb-20 px-6 md:px-12 lg:px-24 flex flex-col items-center text-center min-h-screen justify-center overflow-hidden">
         ...
         <div className="relative z-10 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
           <div className="space-y-8 text-left">
             ...
             <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-tight">
               ...
               <div className="flex justify-start gap-2 flex-wrap">
                 ...
                 <RotatingText
                   texts={["Venda Mais", "Gerencie Melhor", "Cresça Rápido", "Venda Sem Taxas"]}
             ...
             <FadeContent blur={true} duration={1000} ease="power2.out" initialOpacity={0}>
               <p className="text-xl text-neutral-400 max-w-xl">
                 Crie seu cardápio online, compartilhe seu link e receba pedidos automaticamente no WhatsApp e no painel de pedidos.
               </p>
             </FadeContent>
             <div className="flex flex-col sm:flex-row gap-4 justify-start items-start">
               <StarBorder as="button" className="text-lg font-semibold" color="#fb2c36" speed="4s">
                 Criar meu Cardápio
               </StarBorder>
           ...
           <div className="hidden lg:flex items-center justify-center">
             ...
             >
               <div className="p-6">
                 <img src="/image-banner.png" className="w-[1200px] object-cover" alt="imagem de computador e celular do link food" />
               </div>
             </motion.div>
           </div>
         </div>
       ...
       <section id="products" className="py-32 px-6">
         <div className="container mx-auto">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
             <AnimatedContent distance={100} direction="vertical" reverse={false} duration={0.8} delay={0} threshold={0.1} className="md:row-span-2 md:col-span-1 h-full">
               <div className="bg-[#ee121c] rounded-[2rem] p-8 h-full flex flex-col justify-between relative overflow-hidden group hover:scale-[1.01] hover:shadow-2xl hover:shadow-red-700/40 transition-all duration-300">
                 ...
                 <div className="relative z-10">
                   ...
                   <h3 className="text-4xl font-bold mb-4 text-white leading-tight">Crie seu Cardápio em Minutos</h3>
                   <div className="space-y-2 mt-4">
                     {["Cadastre hambúrgueres, pizzas, combos e bebidas", "Atualize preços e produtos quando quiser", "Fique pronto para receber pedidos rapidamente"].map((text) => (
                 ...
                 <div className="mt-8 bg-neutral-950 rounded-t-3xl border-t-8 border-x-8 border-neutral-900 shadow-2xl translate-y-4 group-hover:translate-y-1 transition-transform duration-500 relative w-full overflow-hidden">
                   ...
                   <div className="p-5 pt-10 bg-neutral-950">
                     <div className="flex items-center justify-between mb-4">
                       <p className="text-white font-bold text-base">Meu Cardápio</p>
                       <span className="bg-green-500/20 text-green-400 text-[10px] font-bold px-2 py-0.5 rounded-full">Online</span>
                     </div>
                     <div className="space-y-2">
                       {[{ name: "X-Carne", cat: "Hambúrguer", price: "R$ 28,00", img: "./hb.png" }, { name: "Pizza Bacon", cat: "Pizza", price: "R$ 54,00", img: "./pizza_bacon.png" }].map((item, i) => (
                         <div key={item.name} className={`bg-white rounded-xl p-2.5 flex items-center gap-2.5 transition-transform duration-300 ${i === 0 ? "group-hover:translate-x-1" : "group-hover:-translate-x-1"}`}>
                           <img src={item.img} alt={item.name} className="w-10 h-10 rounded-lg object-cover flex-shrink-0" />
                           <div className="flex-1 min-w-0">
                             <div className="text-[10px] text-gray-400">{item.cat}</div>
                             <div className="text-gray-900 font-semibold text-xs">{item.name}</div>
                           ...
                           <div className="flex flex-col items-end gap-1 flex-shrink-0">
                             ...
                             <span className="text-[9px] px-1.5 py-0.5 rounded-full border text-green-600 border-green-200 bg-green-50">Ativo</span>
                           </div>
                         </div>
                       ))}
                     </div>
             ...
             <AnimatedContent distance={100} direction="vertical" reverse={false} duration={0.8} delay={0.2} threshold={0.1} className="md:col-span-2 h-[400px]">
               <div className="bg-neutral-900 rounded-[2rem] p-8 h-full flex flex-row justify-between relative overflow-hidden group border border-neutral-800 hover:border-red-500/20 hover:shadow-2xl hover:shadow-red-500/5 transition-all duration-300">
                 ...
                 <div className="relative z-10 max-w-sm flex flex-col justify-center">
                   ...
                   <div className="space-y-2 mt-1">
                     {["Acompanhe todos os pedidos instantaneamente", "Visualize status e informações do cliente", "Tudo em um único painel centralizado"].map((text) => (
                       <div key={text} className="flex items-start gap-2">
                         <span className="mt-0.5 w-4 h-4 rounded-full bg-red-500/20 flex items-center justify-center flex-shrink-0">
                           <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                             <path d="M1.5 4L3.5 6L6.5 2" stroke="#ee121c" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                           </svg>
                         </span>
                         <p className="text-neutral-400 text-sm leading-snug">{text}</p>
                       </div>
                     ))}
                   </div>
                   <div className="flex items-center gap-2 mt-6 bg-neutral-800/60 rounded-full px-4 py-2 w-fit border border-neutral-700">
                     ...
                     <span className="text-xs text-neutral-300 font-medium">3 novos pedidos agora</span>
                   </div>
                 </div>
                 <div className="absolute right-4 top-1/2 -translate-y-1/2 w-56 bg-neutral-950 rounded-[2.5rem] border-8 border-neutral-800 p-2 shadow-2xl rotate-[-5deg] group-hover:rotate-0 group-hover:right-8 transition-all duration-500 hidden md:block">
                   <div className="bg-white rounded-[2rem] h-[340px] w-full flex flex-col relative overflow-hidden">
                     ...
                     <div className="mt-6 px-4 py-2 border-b border-gray-100 flex items-center justify-between">
                       <p className="text-[10px] text-gray-800 font-bold">Pedidos</p>
                     </div>
                     <div className="flex flex-col gap-1.5 px-2 pt-2 overflow-hidden">
                       {[{ id: "#0492", name: "Carlos Silva", item: "X-Bacon", total: "R$ 32,00", status: "Novo", statusColor: "bg-blue-500" }, { id: "#0491", name: "Ana Lima", item: "Combo Família", total: "R$ 76,00", status: "Preparo", statusColor: "bg-yellow-500" }, { id: "#0490", name: "Matheus B.", item: "Pizza 4Q", total: "R$ 54,00", status: "Entregue", statusColor: "bg-green-500" }].map((order, i) => (
                         <div key={order.id} className={`bg-white rounded-xl border border-gray-100 shadow-sm px-2.5 py-2 transition-transform duration-300 ${i === 0 ? "group-hover:-translate-y-0.5" : ""}`}>
                           <div className="flex items-center justify-between mb-0.5">
                             <span className="font-bold text-[10px] text-gray-900">{order.id}</span>
                             <span className={`${order.statusColor} text-white text-[8px] font-bold px-1.5 py-0.5 rounded-full`}>{order.status}</span>
                           </div>
                           <p className="text-[9px] text-gray-500">
                             {order.name} · {order.item}
                           </p>
                           <p className="text-[10px] font-bold text-gray-800 mt-0.5">{order.total}</p>
                         </div>
                       ))}
                     </div>
                     <div className="mt-auto mx-2 mb-2 bg-gray-50 rounded-xl px-3 py-2 flex items-center justify-between border border-gray-100">
                       <span className="text-[9px] text-gray-500">Total hoje</span>
                       <span className="text-[11px] font-bold text-gray-900">R$ 1.240,00</span>
                     </div>
                   </div>
                 </div>
               </div>
             </AnimatedContent>
             <AnimatedContent distance={100} direction="vertical" reverse={false} duration={0.8} delay={0.4} threshold={0.1} className="md:col-span-1 h-[320px]">
               <div className="bg-neutral-900 rounded-[2rem] p-8 h-full flex flex-col justify-between relative overflow-hidden border border-neutral-800 hover:border-red-500/30 hover:scale-[1.02] hover:shadow-2xl hover:shadow-red-500/10 transition-all duration-300 cursor-pointer">
                 <div>
                   <h3 className="text-3xl font-bold mb-2 text-white">Pedidos direto no WhatsApp</h3>
                   <p className="text-neutral-400 text-sm leading-relaxed">
                     Receba os pedidos dos seus clientes diretamente no WhatsApp da empresa. Todas as informações chegam organizadas:
                   </p>
                 </div>
                 <div className="grid grid-cols-2 gap-2">
                   {[{ icon: <Package size={14} />, label: "produtos" }, { icon: <User size={14} />, label: "cliente" }, { icon: <DollarSign size={14} />, label: "valor do pedido" }, { icon: <ClipboardList size={14} />, label: "observações" }].map(({ icon, label }) => (
                     <div key={label} className="bg-neutral-800/60 rounded-xl px-3 py-2 flex items-center gap-2 hover:bg-red-500/20 hover:scale-105 border border-transparent hover:border-red-500/30 transition-all duration-200 cursor-pointer">
                       <span className="text-neutral-400">{icon}</span>
                       <span className="text-neutral-300 text-xs font-medium">{label}</span>
                     </div>
                   ))}
                 </div>
               </div>
             </AnimatedContent>
             <AnimatedContent distance={100} direction="vertical" reverse={false} duration={0.8} delay={0.6} threshold={0.1} className="md:col-span-1 h-[320px]">
               <div style={{ backgroundColor: "#ee121c" }} className="rounded-[2rem] p-8 h-full flex flex-col gap-14 relative overflow-hidden hover:scale-[1.02] hover:shadow-2xl hover:shadow-red-700/40 hover:brightness-110 transition-all duration-300 cursor-pointer">
                 <div>
                   <h3 className="text-4xl font-bold mb-2 text-white">Controle total do cardápio</h3>
                   <p className="text-white/80 text-sm leading-relaxed">Gerencie seu cardápio digital com total liberdade.</p>
                 </div>
                 <div className="grid grid-cols-3 gap-2">
                   {[{ icon: <Pencil size={14} />, label: "altere preços" }, { icon: <UtensilsCrossed size={14} />, label: "adicione produtos" }, { icon: <Ticket size={14} />, label: "crie promoções" }].map(({ icon, label }) => (
                     <div key={label} className="bg-white/20 rounded-xl px-2 py-3 flex flex-col items-center gap-2 text-center hover:bg-white/35 hover:scale-110 transition-all duration-200 cursor-pointer">
       ...
       <section className="py-20 border-y border-neutral-900 bg-neutral-950/50">
         <div className="container mx-auto px-6">
           <p className="text-neutral-500 mb-12 uppercase tracking-widest text-sm font-semibold text-center">Trusted by industry leaders</p>
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
             {[{ value: 10, suffix: "k+", label: "Clientes Ativos" }, { value: 35, suffix: "k+", label: "Pessoas que já usaram o Link Food" }, { value: 1, prefix: "R$ ", suffix: "M", label: "Valor em Pedidos" }, { value: 20, suffix: "%", label: "Aumento de Vendas" }].map(({ value, suffix, prefix, label }) => (
       ...
       <section ref={howSectionRef} className="relative bg-neutral-950 overflow-hidden">
         ...
         <div className="container mx-auto px-4 md:px-6 lg:px-12 max-w-5xl">
           <div ref={howTitleRef} className="py-20 md:py-28 text-center">
             ...
             <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-white mb-6 overflow-hidden">
               {"Do cadastro ao primeiro pedido".split(" ").map((word, i) => (
                 <span key={i} className="title-word inline-block mr-3 opacity-0">
                   {word === "primeiro" || word === "pedido" ? <span className="text-[#ee121c]">{word}</span> : word}
                 </span>
               ))}
             </h2>
             <p className="text-neutral-400 text-base md:text-lg max-w-xl mx-auto">
               Configure sua loja em minutos e comece a receber pedidos pelo WhatsApp hoje mesmo.
             </p>
           </div>
           <div className="flex flex-col pb-24">
             {HOW_STEPS.map((step, i) => {
               const isLeft = i % 2 === 0;
               return (
                 <div key={step.title} className={`flex flex-col ${isLeft ? "md:flex-row" : "md:flex-row-reverse"} items-center gap-10 md:gap-16 py-16 md:py-24 border-t border-neutral-800/60`}>
                   <div
                     ref={(el) => {
                   ...
                   >
                     <div className="absolute inset-[-20px] rounded-[3rem] blur-3xl pointer-events-none" style={{ background: step.glowColor }} />
                     ...
                     <div className="absolute -top-4 -right-4 w-10 h-10 rounded-full flex items-center justify-center text-sm font-black shadow-lg border-2 border-neutral-900" style={{ backgroundColor: step.accentColor, color: "#0a0a0a" }}>
                       {i + 1}
                     </div>
                   </div>
                   <div
                   ...
                   >
                     <span className={`step-badge inline-block text-xs font-bold px-3 py-1 rounded-full border w-fit opacity-0 ${step.tagColor}`}>{step.tag}</span>
                     <div>
                       <p className="step-number text-xs text-neutral-500 font-mono mb-1 opacity-0">
                         {String(i + 1).padStart(2, "0")} / {String(HOW_STEPS.length).padStart(2, "0")}
                       </p>
                       <h3 className="step-title text-3xl md:text-4xl font-bold text-white leading-tight opacity-0">{step.title}</h3>
                       <div className="step-line mt-3 h-[3px] w-16 rounded-full" style={{ backgroundColor: step.accentColor, scaleX: 0 }} />
                     </div>
                     <p className="step-desc text-neutral-400 text-base leading-relaxed opacity-0">{step.description}</p>
                     <div className="flex flex-col gap-2 mt-1">
                       {step.checks.map((item, j) => (
                         ...
                         >
                           <span className="w-5 h-5 rounded-full flex items-center justify-center flex-shrink-0" style={{ backgroundColor: `${step.accentColor}25` }}>
                             <svg width="9" height="9" viewBox="0 0 8 8" fill="none">
                               <path d="M1.5 4L3.5 6L6.5 2" stroke={step.accentColor} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                             </svg>
                           </span>
       ...
       <section className="pb-5 bg-neutral-950">
             ...
             <div className="flex items-center justify-center lg:hidden mb-4">
               {(() => {
                 ...
                 return (
                   <button
                     key={t.name}
                     onClick={() => setActiveTestimonial((i + 1) % TESTIMONIALS.length)}
                   ...
                   >
                     <svg className="absolute" viewBox="0 0 96 96" width="96" height="96" aria-hidden="true">
                       <circle cx="48" cy="48" r="46" stroke="rgba(255,255,255,0.2)" strokeWidth="2" fill="none" />
                       <circle
                         ref={(el) => {
                     ...
                     <div className="rounded-full overflow-hidden border-8 border-[#ee121c] transition-all duration-300" style={{ width: 82, height: 82 }}>
         ...
         `}
                   ...
                   >
                     ...
                     <div className={`rounded-full overflow-hidden border-8 transition-all duration-300 ${active ? "border-[#ee121c]" : "border-transparent"}`} style={{ width: active ? 82 : 70, height: active ? 82 : 70 }}>
                       <img src={t.avatar} alt={t.name} className="w-full h-full object-cover" />
                     </div>
                   </button>
                 );
             ...
             <div ref={quoteRef} className="text-left">
               <p className="text-neutral-300 text-lg md:text-xl leading-relaxed max-w-2xl">“{TESTIMONIALS[activeTestimonial].quote}”</p>
               <div className="mt-4 text-sm md:text-base">
                 <span className="text-white font-bold">{TESTIMONIALS[activeTestimonial].name}</span>
                 <span className="text-neutral-400">, {TESTIMONIALS[activeTestimonial].role}</span>
               </div>
             </div>
           </div>
           <div className="mt-16 hidden md:flex flex-wrap items-center justify-between gap-x-12 gap-y-8">
             {BRAND_LOGOS.map((b, i) => (
               <img
                 ...
                 style={{ filter: i === activeTestimonial ? "none" : "grayscale(100%) blur(2px)" }}
               />
             ))}
           </div>
       ...
       <section id="pricing" ref={pricingSectionRef} className="relative py-32 bg-neutral-950 overflow-hidden">
         ...
         <div className="container mx-auto px-6 max-w-6xl">
           <div ref={pricingHeaderRef} className="text-center mb-20 opacity-0">
             ...
             <h2 className="text-4xl md:text-6xl font-bold text-white mb-4 tracking-tight">
               Preço simples e <span className="text-[#ee121c]">transparente</span>
             </h2>
             <p className="text-neutral-400 text-lg max-w-lg mx-auto">
               Sem taxas por pedido. Sem surpresas. Escolha o plano ideal para o seu negócio.
             </p>
           </div>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
             ...
             >
               ...
               <div>
                 <p className="text-neutral-500 text-sm font-semibold uppercase tracking-widest mb-4">Starter</p>
                 <div className="flex items-end gap-1 mb-1">
                   <span className="text-6xl font-black text-white leading-none">R$49</span>
               ...
               <ul className="flex flex-col gap-3 flex-1">
                 {["1 cardápio digital", "Pedidos via WhatsApp", "Até 30 produtos", "Suporte por e-mail"].map((item) => (
                   <li key={item} className="flex items-center gap-3 text-neutral-400 text-sm">
                     <span className="w-4 h-4 rounded-full bg-neutral-800 flex items-center justify-center flex-shrink-0">
                       <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                         <path d="M1.5 4L3.5 6L6.5 2" stroke="#9ca3af" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                       </svg>
                     </span>
                     {item}
                   </li>
             ...
             >
               ...
               <div className="relative bg-neutral-950 rounded-[2rem] p-8 flex flex-col gap-6 h-full">
                 ...
                 <div className="mt-4">
                   <p className="text-red-400 text-sm font-semibold uppercase tracking-widest mb-4">Pro</p>
                   <div className="flex items-end gap-1 mb-1">
                     <span className="text-6xl font-black text-white leading-none">R$99</span>
                     <span className="text-neutral-500 text-base mb-2">/mês</span>
                   </div>
                   <p className="text-neutral-400 text-sm">Para negócios em crescimento</p>
                 </div>
                 <div className="h-px bg-red-500/20" />
                 <ul className="flex flex-col gap-3 flex-1">
                   {["Cardápios ilimitados", "Pedidos via WhatsApp + Painel", "Produtos ilimitados", "Cupons e promoções", "Relatórios de vendas", "Suporte prioritário"].map((item) => (
                     <li key={item} className="flex items-center gap-3 text-neutral-200 text-sm">
             ...
             >
               <div className="absolute inset-0 rounded-[2rem] bg-gradient-to-b from-white/[0.02] to-transparent pointer-events-none" />
               <div>
                 <p className="text-neutral-500 text-sm font-semibold uppercase tracking-widest mb-4">Enterprise</p>
                 <div className="flex items-end gap-1 mb-1">
                   <span className="text-6xl font-black text-white leading-none">R$199</span>
                   <span className="text-neutral-500 text-base mb-2">/mês</span>
                 </div>
                 <p className="text-neutral-500 text-sm">Para redes e franquias</p>
               </div>
               <div className="h-px bg-neutral-800" />
               <ul className="flex flex-col gap-3 flex-1">
                 {["Tudo do plano Pro", "Multi-unidades", "API de integração", "Gerente dedicado", "SLA garantido"].map((item) => (
                   <li key={item} className="flex items-center gap-3 text-neutral-400 text-sm">
                     <span className="w-4 h-4 rounded-full bg-neutral-800 flex items-center justify-center flex-shrink-0">
                       <svg width="8" height="8" viewBox="0 0 8 8" fill="none">
                         <path d="M1.5 4L3.5 6L6.5 2" stroke="#9ca3af" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
           ...
           <p ref={pricingNoteRef} className="text-center text-neutral-600 text-sm mt-10 opacity-0">
             Todos os planos incluem 14 dias grátis · Cancele quando quiser · Sem cartão de crédito
           </p>
         </div>
       </section>
       <div className="relative">
           ...
           >
             ...
             <div className="relative z-10">
               ...
               <p className="text-neutral-400 text-base mb-10 max-w-md mx-auto">
                 Crie seu cardápio digital e comece a receber pedidos pelo WhatsApp hoje mesmo.
               </p>
               <div className="flex flex-col sm:flex-row gap-4 justify-center">
                 <a href="#" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-[#ee121c] text-white font-bold text-sm hover:bg-red-600 hover:scale-105 hover:shadow-xl hover:shadow-red-500/30 transition-all duration-300">
         ...
         <footer ref={footerRef} className="relative bg-[#ee121c] -mt-20 pt-32 pb-12 rounded-t-[3rem] overflow-hidden">
           ...
           <div ref={footerContentRef} className="container mx-auto px-6 relative z-10 opacity-0">
             <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
               <div className="col-span-2 md:col-span-1">
                 <img src="/logo.png" alt="Link Food" className="h-16 w-auto mb-4 hover:opacity-80 transition-opacity duration-200" />
                 <p className="text-white/60 text-sm leading-relaxed max-w-[200px]">Cardápio digital e pedidos via WhatsApp para o seu negócio.</p>
                 <div className="flex items-center gap-3 mt-5">
                   <a href="#" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 hover:bg-white hover:text-[#ee121c] flex items-center justify-center text-white transition-all duration-300 hover:scale-110">
                   ...
                   <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-white/10 hover:bg-white hover:text-[#ee121c] flex items-center justify-center text-white transition-all duration-300 hover:scale-110">
                     <svg width="15" height="15" fill="currentColor" viewBox="0 0 24 24">
               ...
               <div>
                 <h4 className="font-bold mb-5 text-[11px] tracking-widest text-white/90 uppercase">Produto</h4>
                 <ul className="space-y-3">
                   {["Cardápio Digital", "Pedidos via WhatsApp", "Painel de Pedidos", "Relatórios", "Cupons"].map((item) => (
                     <li key={item}>
                       <a href="#" className="text-white/70 hover:text-white text-sm transition-all duration-200 hover:translate-x-1 inline-flex items-center gap-1 group">
                         <span className="w-0 group-hover:w-3 overflow-hidden transition-all duration-200 text-white/90">→</span>
                         {item}
                       </a>
                     </li>
                   ))}
               ...
               <div>
                 <h4 className="font-bold mb-5 text-[11px] tracking-widest text-white/90 uppercase">Empresa</h4>
                 <ul className="space-y-3">
                   {["Sobre nós", "Blog", "Carreiras", "Termos de uso", "Privacidade"].map((item) => (
                     <li key={item}>
                       <a href="#" className="text-white/70 hover:text-white text-sm transition-all duration-200 hover:translate-x-1 inline-flex items-center gap-1 group">
                         <span className="w-0 group-hover:w-3 overflow-hidden transition-all duration-200 text-white/90">→</span>
                         {item}
               ...
               <div>
                 <h4 className="font-bold mb-5 text-[11px] tracking-widest text-white/90 uppercase">Suporte</h4>
                 <ul className="space-y-3">
                   {["Central de Ajuda", "Contato", "Status do sistema", "WhatsApp"].map((item) => (
                     <li key={item}>
                       <a href="#" className="text-white/70 hover:text-white text-sm transition-all duration-200 hover:translate-x-1 inline-flex items-center gap-1 group">
                         <span className="w-0 group-hover:w-3 overflow-hidden transition-all duration-200 text-white/90">→</span>
                         {item}
             ...
             <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
               <p className="text-white/30 text-sm">© 2026 Link Food. Todos os direitos reservados.</p>
               <div className="flex items-center gap-6">
                 {["Termos", "Privacidade", "Cookies"].map((item) => (
                   <a key={item} href="#" className="text-white/30 hover:text-white/70 text-xs transition-colors duration-200">
                     {item}
                   </a>
                 ))}
               </div>
       ...
       >
         <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="currentColor" className="transition-transform group-hover:scale-110">
           <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413" />
         </svg>
       </a>
     </div>
